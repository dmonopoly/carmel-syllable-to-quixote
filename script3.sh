...
carmel --train-cascade -HJ -X .99999 -! 30 -: $cipher_file syllables.wfsa syll_to_type.fst onset_maximizing_filter.fst type_to_more_phonemes.fst diphthong_generator.fst phoneme_to_letter_nsv.fst
...
cat cipher.data.noe | carmel -qbsriWEIk 1 syll_to_type.fst.noe onset_maximizing_filter.fst.trained type_to_more_phonemes.fst.trained diphthong_generator.fst.trained phoneme_to_letter_nsv.fst.trained
