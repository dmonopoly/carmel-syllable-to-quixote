...
carmel --train-cascade -HJ -X .99999 $cipher_file syllables.wfsa syll_to_type.fst onset_maximizing_filter.fst type_to_more_phoneme_classes.fst diphthong_generator2.fst phoneme_class_to_phoneme.fst phoneme_to_letter.fst
