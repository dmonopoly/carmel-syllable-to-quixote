...
./3a.out
clang++ PhonemeClassToLetterNSV_FST.cc CypherReader.cc -o 4.out
./4.out $cipher_file

carmel --train-cascade -HJ -X .99999 -! 20 -: $cipher_file syllables.wfsa syll_to_type.fst onset_maximizing_filter.fst type_to_more_phoneme_classes.fst diphthong_generator2.fst phoneme_class_to_letter_nsv.fst
